...
// fortesque: total coins staked (non-spendable until maturity)
...
// fortesque: get current stake weight
...
// fortesque: check 'spent' consistency between wallet and txindex
// fortesque: fix wallet spent state according to txindex
...
// fortesque: disable transaction (only for coinstake)
